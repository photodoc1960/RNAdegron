...
def train_fold():
    ...
    # Explicitly pad short_preds and short_stds to 91 positions
    ...
    # Directly concatenate labels (matching dimensions explicitly)
    ...
    # Ensure short_stds_padded has correct shape (629,91,5) matching train_ew
    short_stds_padded = np.pad(short_stds, ((0, 0), (0, train_ew.shape[1] - short_stds.shape[1]), (0, 0)),
                               constant_values=0)

    # Ensure long_stds has exactly the same second dimension as train_ew before concatenation
