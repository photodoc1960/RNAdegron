...
def train_fold():
    ...
    if os.path.exists(best_model_path):
        ...
        # If model is wrapped in DataParallel, prepend "module." to keys
        new_state_dict = {}
        for k, v in state_dict.items():
            if 'pretrain_decoders' in k:
                continue  # skip MLM decoder weights
    ...
    for epoch in range(opts.epochs):
        ...
        for data in dataloader:
            ...
            scaler.unscale_(optimizer)  # explicitly unscale for gradient clipping
